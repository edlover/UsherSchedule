...
class ServicesTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $services = [
            ['2017-06-11', '9:30 AM', '', 4],
            ['2017-06-18', '9:30 AM', '', 5],
            ['2017-06-25', '9:30 AM', '', 1],
            ['2017-07-02', '9:30 AM', '', 2],
            ['2017-07-09', '9:30 AM', '', 3],
            ['2017-07-16', '9:30 AM', '', 4],
            ['2017-07-23', '9:30 AM', '', 5],
            ['2017-07-30', '9:30 AM', '', 1],
        ];
